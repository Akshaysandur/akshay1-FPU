...
PATH_GRAPH = {
    ...
    "TopCenter": ["Machine1Entry", "TopDrop", "Machine4Entry"],
    "Machine4Entry": ["TopCenter", "Machine4", "TopRightDrop"],
    "Machine4": ["Machine4Entry"],
    "TopDrop": ["TopCenter", "SpineCenter"],
    "TopRightDrop": ["Machine4Entry", "SpineRight"],
    "LoadingDown": ["Loading", "SpineWest"],
    "SpineWest": ["LoadingDown", "SpineCenter", "Machine2Drop"],
    "SpineCenter": ["SpineWest", "TopDrop", "SpineRight", "Machine3Drop"],
    ...
    "Machine3Drop": ["Machine3Entry", "SpineCenter"],
}
